    @php
        ...
        $adminImageUrl = !empty($user?->image)
            ? asset('public/storage/admin/' . $user->image)
            : asset('public/no_image.jpg');
    @endphp
...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
        ...
        <div class="dropdown-item text-center py-3">
            ...
            <img src="{{ $adminImageUrl }}"
                 class="rounded-circle p-1 shadow mb-2 d-block mx-auto"
                 width="90"
                 height="90"
                 alt=""
                 data-admin-image-fallback>

            <h5 class="user-name mb-0 fw-bold text-center">
                {{ $user->name }}
            </h5>
